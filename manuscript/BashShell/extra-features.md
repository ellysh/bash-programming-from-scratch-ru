...
Для обработки данных на потоке ввода есть целый ряд GNU-утилит. Обычно их используют вместе с конвейерами для поиска и анализа текста. Самые часто используемые из этих утилит приведены в таблице 2-13.

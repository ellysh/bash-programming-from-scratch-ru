...
Рассмотрим ещё один пример. GNU утилита `du` выводит статистику по использованию дискового пространства файлами и каталогами. Если вы запустите утилиту без параметров в текущем каталоге, она рекурсивно обойдёт все подкаталоги и выведет число байт, занимаемым на диске каждым из них.

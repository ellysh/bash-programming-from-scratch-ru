...
Иллюстрация 2-25 демонстрирует результаты выполнения для обоих случаев.

{caption: "Иллюстрация 2-25. Результаты выполнения команд с конвейером и коннектором", height: "50%"}

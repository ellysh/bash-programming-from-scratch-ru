...
Есть ряд GNU утилит, которые работают со стандартным потоком вывода. Обычно именно их применяют вместе с конвейерами. Таблица 2-12 приводит наиболее часто используемые из них.

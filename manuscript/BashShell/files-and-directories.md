...
Второй вариант применяется для приложений с открытым исходным кодом. Каждый тип файлов приложения копируется в соответствующий системный каталог. Список этих каталогов приведён в таблице 2-10.

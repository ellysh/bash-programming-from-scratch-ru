...
Примеры и задания этой главы вы можете запускать на любой современной операционной системе: Windows, macOS или Linux. Чтобы начать работать с Bash, нам понадобится его интерпретатор. Он доступен для каждой из перечисленных ОС.
...
Все команды и скрипты, рассматриваемые в этой главе, должны корректно работать на Windows, Linux и macOS.

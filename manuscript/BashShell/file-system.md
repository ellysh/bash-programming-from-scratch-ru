...
После запуска приложения `msys2.exe` откроется окно [**эмулятора терминала**](https://ru.wikipedia.org/wiki/Эмулятор_терминала**). Терминал — это программа, эмулирующая [устройство для подключения](https://ru.wikipedia.org/wiki/Компьютерный_терминал) к мейнфрейму. Такие относительно дешевые устройства применялись в 70-е и 80-е года для подключения нескольких пользователей к одному компьютеру. Благодаря этому, удавалось эффективнее использовать вычислительные ресурсы дорогих мейнфреймов.

...
Если вам надо вывести содержимое одного из подкаталогов, просто укажите его абсолютный или относительный путь первым параметром `ls`. Иллюстрация 2-9 демонстрирует вывод для команды `ls /`.

...
Знакомство с Unix-окружением и Bash начнём с файловой системы. Сначала рассмотрим, чем отличается структура каталогов Unix от стандарта, принятого в семействе ОС Windows. Затем познакомимся с Bash-командами для навигации по файловой системе.
...
В Unix-окружение MSYS входит набор GNU утилит. Это вспомогательные узкоспециализированные программы. Они предназначены для доступа к функциям ОС. С их помощью можно получить доступ к файловой системе. Следующие команды из таблицы 2-1 выполняются GNU утилитами:

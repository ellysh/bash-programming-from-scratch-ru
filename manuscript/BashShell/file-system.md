...
2. Если есть коробка И НЕ препятствие, двигайся в точку Б. Иначе остановись.
...
Естественный язык плохо подходит для описания логических выражений. Поэтому в алгебре логики применяется формальная математическая запись.

{caption: "Упражнение 2-4. Математическая логика", line-numbers: false}
```
Изучите самостоятельно свойства логических операций. Постарйтесь придумать пример для каждого случая.
```

...
[**Абстракция**](https://ru.wikipedia.org/wiki/Уровень_абстракции_(программирование)) ([abstraction](https://en.wikipedia.org/wiki/Abstraction_(computer_science))) — программа или библиотека, повторяющая основные свойства реального объекта. Абстракции помогают управлять сложностью программных систем. Они скрывают несущественные детали и позволяют обрабатывать разные объекты по одному алгоритму.

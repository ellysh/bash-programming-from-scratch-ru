...
В современном компьютере есть [несколько уровней памяти](https://ru.wikipedia.org/wiki/Иерархия_памяти). Они изображены на иллюстрации 1-5.

{caption: "Иллюстрация 1-5. Уровни памяти персонального компьютера"}

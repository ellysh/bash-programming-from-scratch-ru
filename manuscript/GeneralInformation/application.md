...
Схема на иллюстрации 1-16 выглядит так, словно интерпретатор работает как компилятор, объединённый с линковщиком. Интерпретатор загружает текстовые файлы в оперативную память и переводит их в машинный код. Почему при этом не возникает проблем с объёмом RAM и перекрёстными вызовами функций?

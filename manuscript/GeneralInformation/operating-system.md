...
Кроме возросшей скорости вычислений, компьютеры Цузе отличала ещё одна особенность. В них появилось понятие программы. Теперь с помощью перфокарт вводились не исходные данные задачи, а алгоритмы по которым она решалась. Для ввода данных использовалась клавиатура, отдалённо напоминающая печатную машинку.

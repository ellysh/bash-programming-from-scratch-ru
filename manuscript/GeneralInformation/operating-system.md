...
Попытки решить проблему с наглядным представлением доступных команд привели к созданию [**текстового интерфейса пользователя**](https://ru.wikipedia.org/wiki/Текстовый_интерфейс_пользователя). В нём наряду с буквенными и цифровыми символами используется [**псевдографика**](https://ru.wikipedia.org/wiki/Псевдографика). Под псевдографикой подразумеваются специальные символы, отображающие графические примитивы (например, линии, прямоугольники, треугольники и т.д.). Пример текстового интерфейса пользователя приведён на иллюстрации 1-8. Это программа `htop` для просмотра системных ресурсов.

...
{caption: "Иллюстрация 1-4. Персональный компьютер IBM 5150"}
...
{caption: "Иллюстрация 1-6. Интерфейс командной строки"}
...
{caption: "Иллюстрация 1-7. Текстовый интерфейс пользователя"}
...
{caption: "Иллюстрация 1-8. Мэйнфрейм модели GE-645"}
...
{caption: "Иллюстрация 1-9. Мини-компьютер PDP-7"}

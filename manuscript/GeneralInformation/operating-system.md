...
Первые многозадачные ОС появились задолго до привычных нам [**персональных компьютеров**](https://ru.wikipedia.org/wiki/Персональный_компьютер#История) (ПК). В 1960-х годах такие системы работали на [**мейнфреймах**](https://ru.wikipedia.org/wiki/Мейнфрейм) и решали задачу эффективного использования вычислительного времени. Мэйнфрейм — это большой высокопроизводительный универсальный компьютер. Как правило, он стоил дорого и очень интенсивно использовался для расчётов.
...
Мы разобрались, почему многозадачность актуальна для высокопроизводительных мейнфреймов. Но она так же очень важна для менее мощных персональных компьютеров. Почему?
...
Сама Unix возникла в конце 1960-х годов. Она создавалась как хобби-проект двумя инженерами компании Bell Labs: [Кеном Томпсоном](https://ru.wikipedia.org/wiki/Томпсон,_Кен) и [Деннисом Ритчи](https://ru.wikipedia.org/wiki/Ритчи,_Деннис). Они участвовали в крупном проекте компании по разработке ОС [**Multics**](https://ru.wikipedia.org/wiki/Multics) для нового мейнфрейма GE-645 (см. иллюстрацию 1-9) от компании General Electric. Кроме Bell Labs и General Electric над проектом также работал Массачусетский Технологический Институт (MIT).

{caption: "Иллюстрация 1-9. Мэйнфрейм модели GE-645", height: "30%"}
![Мэйнфрейм модели GE-645](images/GeneralInformation/ge-645.jpg)

В ОС Multics планировалось реализовать много инновационных идей. Одной из её ключевых особенностей было [**разделение времени**](https://ru.wikipedia.org/wiki/Разделение_времени). Это означает, что с одним мейнфреймом одновременно может работать несколько пользователей. При этом вычислительные ресурсы компьютера разделяются между ними с помощью многозадачности.

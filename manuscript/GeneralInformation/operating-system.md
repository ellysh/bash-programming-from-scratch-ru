...
В 1944 году [Джон фон Нейман](https://ru.wikipedia.org/wiki/Нейман,_Джон_фон) присоединился к разработке ENIAC в качестве консультанта. После ввода компьютера в эксплуатацию фон Нейман разобрав вместе с коллегами возникшие технические проблемы. Результат этого исследования был опубликован в документе под названием ["Первый проект отчёта о EDVAC"](https://ru.wikipedia.org/wiki/Первый_проект_отчёта_о_EDVAC). В нём предлагалась архитектура нового электронного компьютера под названием [**EDVAC**](https://ru.wikipedia.org/wiki/EDVAC). Позднее она стала известна как [**архитектура фон Неймана**](https://ru.wikipedia.org/wiki/Архитектура_фон_Неймана) и легла в основу большинства современных компьютеров.

...
Однако, увеличение мощности персональных компьютеров привело к значительному простою центрального процессора. Почему это произошло? Опять всё дело в операциях ввода-вывода данных.

...
{caption: "Иллюстрация 2-18. Значение переменной `PATH`", height: "30%"}
...
// TODO: Как запускать файлы с правами на запуск. Рассказать про пути PATH, где будет поиск приложения.

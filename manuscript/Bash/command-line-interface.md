...
> На иллюстрации 2-22 обратите внимание на команду `ls`, запущенную с параметром `-l`. Она выводит таблицу с подробной информацией о файлах и каталогах. Каждому из них соответствует одна строка. В первом столбце таблицы указаны права доступа к соответствующему файлу или каталогу (например, `-rw-r--r--`). Мы рассмотрим эти права далее.

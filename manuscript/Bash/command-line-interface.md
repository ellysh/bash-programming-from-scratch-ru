...
```
Какой из следующих строк соответствует шаблон `*ME.??`:
* 00_README.txt
* README
* README.md
```
...
I> Обратите внимание, что действие `-exec` с `{} +` на конце вы можете указывать только для команд, поддерживающих несколько аргументов. Большинство GNU утилит их поддерживает.

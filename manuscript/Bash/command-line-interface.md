...
| | `ls /c/Windows` |
| --- | --- | --- |
| `pwd` | Вывод на экран пути до текущего каталога. Ключ `-W` позволяет вывести путь в структуре каталогов Windows | `pwd` |
| | `pwd -W` |
| --- | --- | --- |

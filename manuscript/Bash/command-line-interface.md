...
Теперь если мы вернёмся к иллюстрации 2-22, мы легко сможем прочитать права доступа к файлам `report.txt` и `report1.txt`. Первый могут читать все пользователи, но его изменение и исполнение запрещено. Второй файл могут читать все, а изменять только владелец. При этом его исполнение также запрещено.

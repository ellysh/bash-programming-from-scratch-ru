...
* 25649 << 2 = 0110 0100 0011 0001 << 2 = 10 0100 0011 0001 -> 1001 0000 1100 0100 = -28476

* -9154 >> 4 = 1101 1100 0011 1110 >> 4 = 1101 1100 0011 -> 1111 1101 1100 0011 = -573

* -9154 << 3 = 1101 1100 0011 1110 << 3 = 1 1100 0011 1110 -> 1110 0001 1111 0000 = -7696
```
...
Начнём с вывода "main1" и "main2". Переменная `var` объявлена в функции `foo` с атрибутом `local`. Поэтому она доступна только в функциях `foo` и `bar`. Следовательно, до и после вызова `foo` переменная `var`считается необъявленной. Необъявленные переменные имеют пустое значение в Bash.

...
##### Упражнение 3-6. Арифметические действия в дополнительном коде
...
##### Упражнение 3-7. Вычисление остатка от деления и modulo
...
##### Упражнение 3-8. Вычисление побитового отрицания
...
Число 58362 не может быть представлено в виде знакового двухбайтового целого из-за переполнения. Если записать соответствующие ему биты в переменную такого типа, мы получим число -7174. Перевод числа в прямой код будет выглядеть следующим образом:

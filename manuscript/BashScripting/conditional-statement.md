...
|        | != | Строки не равны. | [[ abc != ab ]] && echo "Строки не равны" |
|  | | | |
|        | -gt | Больше. | [[ 6 -gt 3 ]] && echo "6 больше чем 3" |
|        | -lt | Меньше. | [[ 3 -lt 6 ]] && echo "3 меньше чем 6" |
|  Числа | -ge | Больше или равно. | [[ 7 -ge 7 ]] && echo "7 больше или равно 7" |
|        | -le | Меньше или равно. | [[ 2 -le 2 ]] && echo "2 меньше или равно 2" |
|        | -eq | Равно. | [[ 5 -eq 5 ]] && echo "5 равно 5" |
|        | -ne | Не равно. | [[ 1 -nq 9 ]] && echo "1 не равно 9" |
|  | | | |
| Условные  | && | Логическое И. | [[ abc = abc && 3 -eq 3 ]] && echo "строки и числа равны" |
| выражения | || | Логическое ИЛИ. | [[ abc = ab || 3 -eq 3 ]] && echo "строки или числа равны" |
|  | | | |
| Шаблоны | = или == | Поск подстроки по шаблону. | [[ $filename = READ* ]] && echo "имя файла начинается с READ" |
|  | | | |
| Регулярные выражения | =~ | Поск подстроки по регулярному выражению. | [[ $filename =~ ^READ.* ]] && echo "имя файла начинается с READ" |

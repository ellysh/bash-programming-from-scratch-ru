...
Задача решаемая конструкцией `case` близка задаче, решаемой ассоциативными массивами. Массивы устанавливают соответствие между данными, а конструкция `case` между данными и командами. Как правило оперировать данными намного удобнее чем кодом. Их проще изменять и контролировать их корректность. Часто вы можете заменить конструкцию `case` на ассоциативный массив.

Рассмотрим пример.

// TODO: В массиве хранятся имена команд. Дать инфо блок про функции.
...
Польза комментариев — это предмет бесконечных споров в сообществе программистов. Они нужны для пояснений к коду. Если вы только начинаете изучать программирование, комментарии будут вам однозначно полезны. Комментируйте сложные конструкции в своих скриптах, смысл которых вы можете забыть. В будущем это поможет вам вспомнить, как они работают.

...
В этой конструкции блок команд, обозначенный как ДЕЙСТВИЕ_2, будет выполняться, если УСЛОВИЕ вернёт код ошибки отличный от 0. В противном случае исполнится ДЕЙСТВИЕ_1.
...
В такой конструкции количество блоков `elif` не ограничено.

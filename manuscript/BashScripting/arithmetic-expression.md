...
В первом варианте все разряды двоичного числа используются для хранения его значения. Примеры хранения беззнаковых целых в прямом коде приведены в таблице 3-13.
...
Таблица 3-15 демонстрирует представление некоторых чисел в обратном коде.

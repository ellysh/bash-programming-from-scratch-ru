...
Битовые операции находят широкое применение в [системном программировании](https://ru.wikipedia.org/wiki/Системное_программное_обеспечение). К нему относится разработка драйверов устройств, ядер и модулей ОС, системных библиотек и стеков сетевых протоколов. Как правило потребность в битовых операциях возникает, когда необходимо интерпретировать содержание памяти 

...
Битовым сдвигом называется смена позиций битов числа. Всего есть три типа сдвигов:
...
Теперь отбросим три бита числа 58 справа:
{line-numbers: false}
```
0011 1010 >> 3 = 0011 1
```
...
Попробуем сдвинуть то же число 58 на три бита влево. Получим следующее:
{line-numbers: false}
```

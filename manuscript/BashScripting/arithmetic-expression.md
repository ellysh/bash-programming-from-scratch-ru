...
Операция сдвига принимает два операнда. Первый из них — это число для сдвига, а второй — количество битов, на которое происходит сдвиг.
...
Операция сдвига влево обозначается как `<<`, а в право так `>>`. Выполним логический сдвиг числа 58 вправо на три бита:
{line-numbers: false}
```

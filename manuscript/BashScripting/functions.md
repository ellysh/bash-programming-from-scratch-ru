...
Второй способ вернуть значение из функции — воспользоваться глобальной в области видимости скрипта переменной. Такая переменная доступная в любой месте скрипта. По умолчанию все переменные, объявленные в скрипте являются глобальными.

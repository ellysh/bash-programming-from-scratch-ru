...
В целом для всех процедурных языков справедлива рекомендация избегать глобальных переменных. К сожалению, в Bash очень сложно ей следовать. Дело в том, что практически всегда при объявлении переменной в Bash она попадает в глобальную область видимости. Однако, функции позволяют исправить эту ситуацию.

...
Функции в Bash, в отличие от большинства других процедурных языков, не могут возвращать произвольное значение. Вместо этого они могут вернуть только код возврата.

Механизм возврата значения функцией обычно работает по следующему алгоритму:

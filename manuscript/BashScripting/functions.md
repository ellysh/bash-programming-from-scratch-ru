...
Вы можете добавлять объявления функций в файл `~/.bashrc` точно так же как и псевдонимов alias. Тогда они будут доступны при каждом запуске командной оболочке.

...
I> Обратите внимание на одинарные кавычки `'`. Еслди использовать двойные — Bash выполнит подстановку. В результате чего получится следующая команда вызова `bash`:
{line-numbers: false, format: Bash}
```

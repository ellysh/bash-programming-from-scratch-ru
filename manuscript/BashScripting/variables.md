...
Первые были унаследованы из Bourne Shell и нужны для обсепечения POSIX-совместимости. Наиболее часто используемые из них представлены в таблице 3-4.
...
В Bash были добавлены новые зарезервированные переменные. Наиболее часто используемые из них представлены в таблице 3-5.
...
Наиболее часто используемые из них представлены в таблице 3-6.

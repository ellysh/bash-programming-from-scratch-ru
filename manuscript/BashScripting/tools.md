...
Вы можете запускать редактор исходного кода через графический интерфейс. Например, через меню Пуск или иконка рабочего стола в Windows. Альтернативный вариант - интегрировать редактор в Bash. Для этого добавьте путь до каталога его установки в файл `.bash_profile`:

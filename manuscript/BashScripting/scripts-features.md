...
Мы написали длинную и сложную команду резервного копирования. Предположим, что её надо выполнять регулярно. Тогда нам потребуется где-то её сохранить, чтобы не набирать каждый раз в окне терминала.

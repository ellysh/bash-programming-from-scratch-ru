...
На самом деле причин ошибочных решений много. В нашем случае это пример нежелания учиться новому. Мы освоились с работой Bash в режиме командного интерпретатора. Но применяя полученные знания для новой задачи резервного копирования, мы не учли в полной мере её требования. Кроме непосредственного резервного копирования, необходимо обеспечить следующее:
